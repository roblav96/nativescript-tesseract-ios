...
declare class GPUImageFilterPipeline extends NSObject {
	...
	constructor(o: { orderedFilters: NSArray<any>; input: GPUImageOutput; output: GPUImageInput; });
	...
	initWithOrderedFiltersInputOutput(filters: NSArray<any>, input: GPUImageOutput, output: GPUImageInput): this;
	...
	replaceAllFilters(newFilters: NSArray<any>): void;
...
declare class GPUImageRawDataInput extends GPUImageOutput {
	...
	constructor(o: { bytes: string; size: CGSize; });

	constructor(o: { bytes: string; size: CGSize; pixelFormat: GPUPixelFormat; });

	constructor(o: { bytes: string; size: CGSize; pixelFormat: GPUPixelFormat; type: GPUPixelType; });

	initWithBytesSize(bytesToUpload: string, imageSize: CGSize): this;

	initWithBytesSizePixelFormat(bytesToUpload: string, imageSize: CGSize, pixelFormat: GPUPixelFormat): this;

	initWithBytesSizePixelFormatType(bytesToUpload: string, imageSize: CGSize, pixelFormat: GPUPixelFormat, pixelType: GPUPixelType): this;
	...
	updateDataFromBytesSize(bytesToUpload: string, imageSize: CGSize): void;
}
...
declare class GPUImageToneCurveFilter extends GPUImageFilter {
	...
	getPreparedSplineCurve(points: NSArray<any>): NSMutableArray<any>;
	...
	secondDerivative(cgPoints: NSArray<any>): NSMutableArray<any>;

	setPointsWithACV(curveFilename: string): void;

	setPointsWithACVURL(curveFileURL: NSURL): void;

	setRGBControlPoints(points: NSArray<any>): void;

	splineCurve(points: NSArray<any>): NSMutableArray<any>;
...
declare class GPUImageView extends UIView implements GPUImageInput {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject>): GPUImageView; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): GPUImageView; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): GPUImageView; // inherited from UIAppearance
