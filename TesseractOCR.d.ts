...
declare class G8Tesseract extends NSObject {
	...
	/* readonly */ characterChoices: NSArray;
	...
	constructor(o: { language: string; configDictionary: NSDictionary; configFileNames: NSArray; absoluteDataPath: string; engineMode: G8OCREngineMode; copyFilesFromResources: boolean; });

	constructor(o: { language: string; configDictionary: NSDictionary; configFileNames: NSArray; cachesRelatedDataPath: string; engineMode: G8OCREngineMode; });

	constructor(o: { language: string; engineMode: G8OCREngineMode; });

	analyseLayout(): void;

	imageWithBlocksDrawTextThresholded(blocks: NSArray, drawText: boolean, thresholded: boolean): UIImage;

	initWithLanguage(language: string): this;

	initWithLanguageConfigDictionaryConfigFileNamesAbsoluteDataPathEngineModeCopyFilesFromResources(language: string, configDictionary: NSDictionary, configFileNames: NSArray, absoluteDataPath: string, engineMode: G8OCREngineMode, copyFilesFromResources: boolean): this;

	initWithLanguageConfigDictionaryConfigFileNamesCachesRelatedDataPathEngineMode(language: string, configDictionary: NSDictionary, configFileNames: NSArray, cachesRelatedDataPath: string, engineMode: G8OCREngineMode): this;

	initWithLanguageEngineMode(language: string, engineMode: G8OCREngineMode): this;

	recognize(): boolean;

	recognizedBlocksByIteratorLevel(pageIteratorLevel: G8PageIteratorLevel): NSArray;

	recognizedHOCRForPageNumber(pageNumber: number): string;

	setVariableValueForKey(value: string, key: string): void;

	setVariablesFromDictionary(dictionary: NSDictionary): void;
